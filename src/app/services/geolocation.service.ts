...
export class GeolocationService {
  ...
  public async takeGeolocation() : Promise<[number | null, string, number | null]> {
    try {
      ...
      return [endereco.results[0].address_components[6].long_name, endereco.results[0].address_components[1].long_name, endereco.results[0].address_components[0].long_name];
